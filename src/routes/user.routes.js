...
router.route("/avatar").patch(verifyRoute,upload.single("avatar"),updateUserAvatar);
router.route("/cover-image").patch(verifyRoute,upload.single("coverImage"),updateUserCoverImage);
